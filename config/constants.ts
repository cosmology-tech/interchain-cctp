...
export const INFURA_ETHEREUM_MAINNET_URL = `https://mainnet.infura.io/v3/${INFURA_ID}`;
export const INFURA_ARBITRUM_MAINNET_URL = `https://arbitrum-mainnet.infura.io/v3/${INFURA_ID}`;
export const INFURA_OPTIMISM_MAINNET_URL = `https://optimism-mainnet.infura.io/v3/${INFURA_ID}`;
export const INFURA_POLYGON_MAINNET_URL = `https://polygon-mainnet.infura.io/v3/${INFURA_ID}`;
export const INFURA_AVALANCHE_MAINNET_URL = `https://avalanche-mainnet.infura.io/v3/${INFURA_ID}`;

export const INFURA_AVALANCHE_TESTNET_URL = `https://avalanche-fuji.infura.io/v3/${INFURA_ID}`;
...
export const EVM_CHAIN_ID_TO_TOKEN = { ...USDC_EVM_MAINNET, ...USDC_EVM_TESTNET };
...
export const COSMOS_CHAIN_ID_TO_USDC_IBC_DENOM = {
  ...
  'archway-1': 'ibc/43897B9739BD63E3A08A88191999C632E052724AB96BD4C74AE31375C991F48D',
  'miagloo-1': 'ibc/BC5C0BAFD19A5E4133FDA0F3E04AE1FBEE75A4A226554B2CBB021089FF2E1F8A',
  'injective-1': 'ibc/2CBC2EA121AE42563B08028466F37B600F2D7D4282342DE938283CC3FB2BC00E'
};
