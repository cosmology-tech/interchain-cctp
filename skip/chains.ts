import type { ChainJSON } from '@skip-router/core';
...
export const SkipChains: SkipChain[] = [
  ...
  },
  {
    ...
    fee_assets: [
      {
        denom: 'ibc/D031367F58DFD5EED54A49ADCB4EFB44AD9ECCAE383708BFDCCACF3CF463B77C',
        gas_price: {
          low: '0.0002',
          average: '0.0005',
          high: '0.0008'
      ...
      {
        denom: 'ibc/961FA3E54F5DCCA639F37A7C45F7BBE41815579EF1513B5AFBEFCFEB8F256352',
        gas_price: {
          low: '0.0001',
          average: '0.001',
          high: '0.01'
  ...
  },
  {
    ...
    supports_memo: true,
    logo_uri: 'https://raw.githubusercontent.com/cosmos/chain-registry/master/odin/images/odin.png',
    bech32_prefix: 'odin',
    fee_assets: [],
    chain_type: 'cosmos',
    ibc_capabilities: {
